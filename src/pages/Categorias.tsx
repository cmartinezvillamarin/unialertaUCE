...
export default function Categorias() {
  ...
  // Hook de bulk actions escalable para categorías (+1000 registros)
  ...
  const actions: BulkAction[] = [
    {
      ...
      variant: 'outline',
      requiredPermission: 'editar_categoria',
    },
    {
      id: 'delete',
      label: 'Eliminar',
      ...
      variant: 'destructive',
      requiredPermission: 'eliminar_categoria',
    },
  ];
