  ...
  public: {
    Tables: {
      active_trackings: {
        ...
        Relationships: [
          {
            foreignKeyName: "active_trackings_asignado_a_fkey"
            columns: ["asignado_a"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "active_trackings_creador_id_fkey"
            columns: ["creador_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "active_trackings_reporte_id_fkey"
            columns: ["reporte_id"]
            isOneToOne: true
      ...
      reporte_historial: {
        Row: {
          ...
          reporte_id: string
          tipo_accion: Database["public"]["Enums"]["reporte_historial_tipo"]
          updated_at: string
        }
        Insert: {
          assigned_by?: string | null
    ...
    Functions: {
      ...
      is_social_authenticated: { Args: never; Returns: boolean }
