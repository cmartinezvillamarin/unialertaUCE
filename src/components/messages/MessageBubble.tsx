 ...
 * Soporta contenido compartido (publicaciones/estados/reportes)
 */
...
import { SharedReportCard, isSharedReportData, type SharedReportData } from './SharedReportCard';
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          {isEditing ? (
            ...
            <>
              {/* Contenido compartido (publicación/estado/reporte) */}
              {message.shared_post && (
                <div className="w-full max-w-[280px] mb-2">
                  {isSharedReportData(message.shared_post) ? (
                    <SharedReportCard
                      data={message.shared_post as SharedReportData}
                      isOwn={isOwn}
                    />
                  ) : (
                    <SharedPostCard
