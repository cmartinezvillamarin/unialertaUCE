...
interface PostCardProps {
  ...
  // Para filtrar por hashtag o mención al hacer clic
...
function PostCardContent({ post, currentUserId, onPostUpdated, allPosts = [], onNavigateToPost, onHashtagClick, onMentionClick }: { post: Publicacion; currentUserId?: string | null; onPostUpdated?: () => void; allPosts?: Publicacion[]; onNavigateToPost?: (postId: string) => void; onHashtagClick?: (hashtag: string) => void; onMentionClick?: (username: string) => void }) {
  ...
  // Renderizar contenido con hashtags y menciones resaltados y clickeables
