        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full max-w-4xl mx-auto">
            <TabsList className="grid w-full grid-cols-4 mb-6 h-auto p-1">
              <TabsTrigger value="general" className="gap-1 sm:gap-2 px-1 sm:px-3 py-2 text-xs sm:text-sm">
                <Palette className="h-4 w-4 shrink-0" />
                <span className="hidden xs:inline sm:inline">General</span>
              </TabsTrigger>
              <TabsTrigger value="notificaciones" className="gap-1 sm:gap-2 px-1 sm:px-3 py-2 text-xs sm:text-sm">
                <Bell className="h-4 w-4 shrink-0" />
                <span className="hidden xs:inline sm:inline">Notif.</span>
              </TabsTrigger>
              <TabsTrigger value="compartir" className="gap-1 sm:gap-2 px-1 sm:px-3 py-2 text-xs sm:text-sm">
                <Share2 className="h-4 w-4 shrink-0" />
                <span className="hidden xs:inline sm:inline">Compartir</span>
              </TabsTrigger>
              <TabsTrigger value="mensajes" className="gap-1 sm:gap-2 px-1 sm:px-3 py-2 text-xs sm:text-sm">
                <MessageSquare className="h-4 w-4 shrink-0" />
                <span className="hidden xs:inline sm:inline">Mensajes</span>
              </TabsTrigger>
            </TabsList>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground bg-muted/50 p-2 rounded-md">
                      {permission === 'granted' 
                        ? 'Las notificaciones push están activas. Para desactivarlas, haz clic en el icono de candado en la barra de direcciones del navegador.'
                        : permission === 'denied'
                        ...
                        : 'Para activar las notificaciones push, haz clic en el icono de candado 🔒 en la barra de direcciones del navegador y permite las notificaciones para este sitio.'
                      }
                    </p>
                    {!isSupported && (
                      <p className="text-xs text-muted-foreground bg-destructive/10 p-2 rounded-md">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Publicar reportes como historias/estados en mensajes
                      </p>
                    </div>
                    <Switch
